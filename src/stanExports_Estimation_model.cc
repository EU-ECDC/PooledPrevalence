...
#include "stanExports_Estimation_model.h"

RCPP_MODULE(stan_fit4Estimation_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Estimation_model")
